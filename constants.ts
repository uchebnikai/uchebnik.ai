...
export const AI_MODELS = [
  ...
  { id: 'google/gemini-2.0-flash-exp:free', name: 'Gemini 2.0 Flash', description: 'Бърз и интелигентен модел.' },
  { id: 'tngtech/deepseek-r1t2-chimera:free', name: 'DeepSeek R1', description: 'Отличен за логика и математика.' }
];
