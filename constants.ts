...
export const SYSTEM_PROMPTS = {
  ...
  ГРАФИКИ И ДАННИ:
  Ако даден въпрос изисква анализ на данни (графика, диаграма), ВКЛЮЧИ поле "chartData" към обекта на въпроса. Не питай, просто го генерирай, ако е уместно.
  ...
  Формат на JSON (schema):
  {
    ...
    "questions": [
       {
         "id": 1,
         "question": "Текст на въпроса (напр. 'Анализирайте графиката по-долу')",
         "type": "multiple_choice" или "open_answer",
         "options": ["А) ...", "Б) ..."], 
         "correctAnswer": "Верен отговор",
         "chartData": { // ОПЦИОНАЛНО, само ако е нужно
            "type": "line" или "bar",
            "title": "Заглавие на графиката",
            "data": [{"name": "Яну", "value": 10}, {"name": "Фев", "value": 20}] 
         }
       }
    ]
  }
