...
export const WelcomeScreen = ({
  ...
  onQuickStart
    ...
    return (
    <div className={`flex flex-col h-full overflow-hidden p-4 md:p-8 items-center bg-transparent`}>
      ...
      {homeView === 'landing' && (
        <div className={`w-full max-w-5xl flex-1 flex flex-col items-center justify-center relative z-10 ${ZOOM_IN} duration-700`}>
          ...
          <div className="text-center mb-6 md:mb-10 space-y-3 px-2 w-full mt-4 md:mt-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full px-2 md:px-12 max-w-4xl mb-6 md:mb-10 flex-1 sm:flex-none h-full sm:h-auto min-h-0 overflow-y-auto sm:overflow-visible no-scrollbar pb-2">
            {/* General Chat */}
      ...
      {homeView === 'school_select' && (
        <div className={`max-w-5xl w-full flex-1 flex flex-col items-center justify-center relative z-10 ${SLIDE_UP} duration-500 overflow-y-auto custom-scrollbar`}>
             <button onClick={() => setHomeView('landing')} className="absolute top-0 left-0 flex items-center gap-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors font-bold z-20"><ArrowLeft size={20}/> Назад</button>
             <h2 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white mb-8 md:mb-12 tracking-tight mt-10 md:mt-0">Избери Роля</h2>
