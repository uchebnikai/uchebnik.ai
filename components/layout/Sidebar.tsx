...
export const Sidebar = ({
  ...
  syncStatus = 'synced'
    ...
    // Mobile: Controlled by sidebarOpen prop (toggled by burger menu)
    // Desktop: Controlled by isHovered state (hover edge/sidebar)
    ...
    return (
      <>
        ...
        >
            ...
            >
                {/* Trigger Zone (Invisible but hoverable) */}
                ...
                <aside className={`
                    ...
                    transition-transform duration-500 cubic-bezier(0.19, 1, 0.22, 1) flex flex-col 
                    shadow-2xl
